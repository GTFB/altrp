...
export const MessageThread: CollectionConfig = {
  slug: 'message_threads',
  labels: { singular: 'Message Thread', plural: 'Message Threads' },
  ...
  fields: [
    ...
    { name: 'maid', type: 'text', required: true },
    { name: 'parent_maid', type: 'text' },
