...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`ALTER TABLE \`payload_locked_documents_rels\` ADD \`employees_id\` integer REFERENCES employees(id);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "settings_id", "taxonomy_id", "media_id", "pages_id", "posts_id", "users_id", "journals_id", "assets_id", "asset_variants_id", "bases_id", "base_moves_id", "base_move_routes_id", "contractors_id", "deals_id", "deal_products_id", "echelons_id", "echelon_employees_id", "employee_leaves_id", "employee_timesheets_id", "expanses_id", "finances_id", "goals_id", "humans_id", "identities_id", "journal_connections_id", "journal_generations_id", "journal_system_id", "keys_id", "locations_id", "messages_id", "message_threads_id", "notices_id", "outreaches_id", "outreach_referrals_id", "permissions_id", "products_id", "product_variants_id", "qualifications_id", "relations_id", "roles_id", "role_permissions_id", "user_roles_id", "segments_id", "texts_id", "text_variants_id", "universities_id", "user_bans_id", "user_sessions_id", "user_verifications_id", "votes_id", "wallets_id", "wallet_transactions_id", "yields_id", "zoos_id", "redirects_id", "forms_id", "form_submissions_id", "search_id", "payload_jobs_id") SELECT "id", "order", "parent_id", "path", "settings_id", "taxonomy_id", "media_id", "pages_id", "posts_id", "users_id", "journals_id", "assets_id", "asset_variants_id", "bases_id", "base_moves_id", "base_move_routes_id", "contractors_id", "deals_id", "deal_products_id", "echelons_id", "echelon_employees_id", "employee_leaves_id", "employee_timesheets_id", "expanses_id", "finances_id", "goals_id", "humans_id", "identities_id", "journal_connections_id", "journal_generations_id", "journal_system_id", "keys_id", "locations_id", "messages_id", "message_threads_id", "notices_id", "outreaches_id", "outreach_referrals_id", "permissions_id", "products_id", "product_variants_id", "qualifications_id", "relations_id", "roles_id", "role_permissions_id", "user_roles_id", "segments_id", "texts_id", "text_variants_id", "universities_id", "user_bans_id", "user_sessions_id", "user_verifications_id", "votes_id", "wallets_id", "wallet_transactions_id", "yields_id", "zoos_id", "redirects_id", "forms_id", "form_submissions_id", "search_id", "payload_jobs_id" FROM \`payload_locked_documents_rels\`;`)
