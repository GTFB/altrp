...
export const createD1Config = (d1Binding) => {
  return buildConfig({
    db: sqliteD1Adapter({
      // @ts-ignore
      binding: d1Binding,
    ...
    collections: [
      Setting, Taxonomy, Media, Pages, Posts, User, Journal, Asset, AssetVariant, Base,
      BaseMove, BaseMoveRout, Contractor, Deal, DealProduct, Echelon, EchelonEmployee,
      EmployeeLeave, EmployeeTimesheet, Expanse, Finance, Goal, Human, Identity,
      JournalConnection, JournalGeneration, JournalSystem, Key, Location, Message,
      MessageThread, Notice, Outreach, OutreachReferral, Permission, Product, ProductVariant,
      Qualification, Relation, Role, RolePermission, UserRole, Segment, Text, TextVariant,
      University, UserBan, UserSession, UserVerification, Vote, Wallet, WalletTransaction,
      Yield, Zoo,
    ],
