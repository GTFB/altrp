...
// Автоматический экспорт всех флоу из папки flows
// Этот файл автоматически подхватывает все .ts файлы в папке flows
// и экспортирует их как единый объект flows
