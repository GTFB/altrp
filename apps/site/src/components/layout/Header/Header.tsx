        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <NavigationMenu className="hidden md:flex">
            <NavigationMenuList>
                ...
                <NavigationMenuContent>
                  <div className="grid gap-3 p-4 w-[400px]">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Link href={`${localePath}/features`} className="block p-2 rounded-md hover:bg-accent">
                      ...
                      <Link href={`${localePath}/integrations`} className="block p-2 rounded-md hover:bg-accent">
              ...
              <NavigationMenuItem>
                <Link href={`${localePath}/pricing`} legacyBehavior passHref>
              ...
              <NavigationMenuItem>
                <Link href={`${localePath}/docs`} legacyBehavior passHref>
                  <NavigationMenuLink className="group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 font-sans">
                    t('docs')
                  </NavigationMenuLink>
                </Link>
            ...
            <Sheet>
              ...
              <SheetContent side="right">
                <div className="flex flex-col space-y-4 mt-8">
                  <Link href={`${localePath}/features`} className="font-sans">t('features')</Link>
                  <Link href={`${localePath}/pricing`} className="font-sans">t('pricing')</Link>
                  <Link href={`${localePath}/docs`} className="font-sans">t('docs')</Link>
